...
def ClusterMap(clusters, vals, indicesToShow,
    ...
    elementCount = (3*len(indicesToShow)) + (radarBG_alpha > 0.0) + (dimmerBox_alpha > 0.0)
    ...
    if radarBG_alpha > 0.0 :
        MakeReflectPPI(vals, lats, lons, mask=domainMask,
        	       colorbar=False, axis_labels=False, axis=axis,
	...
	outline = axis.contour(lons, lats, clustMask, 
        ...
        MakeReflectPPI(vals, lats, lons, mask=clustMask, axis=axis, zorder=zorders[zorderIndex + 2],
